...
export interface IStorage {
  ...
  subscribeNewsletter(data: any): Promise<NewsletterSubscription>;
...
// In-memory storage implementation for serverless
class MemStorage implements IStorage {
  ...
  async createRegistration(data: any): Promise<Registration> {
    const id = randomUUID();
  ...
  async subscribeNewsletter(data: any): Promise<NewsletterSubscription> {
