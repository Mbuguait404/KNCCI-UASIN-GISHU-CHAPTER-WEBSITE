...
export const staticEvent: Event = {
  ...
  description: "The 4th Edition of the Eldoret International Business Summit is the premier gathering for trade, innovation, and economic transformation in East Africa. Join 5000+ business leaders for a transformative three-day experience.",
  date: "2026-07-23",
  endDate: "2026-07-25",
  location: "Rupaz Mall Grounds",
  venue: "Eldoret City, Kenya",
  highlights: [
    "Networking with 5000+ business leaders",
    "200+ industry speakers",
    "60+ sessions and workshops",
    "Business exhibitions and trade fairs",
  ],
  tagline: "4TH EDITION | Gateway to Africa's Trade & Innovation",
  stats: {
    visitors: "5,000+",
    exhibitors: "60+",
    delegates: "5,000+",
    participatingNations: "15+",
    speakers: "200+",
    sessions: "60+",
  },
};
...
export const staticSchedule: Session[] = [
  { id: "1", day: 1, dayLabel: "Day 1 - July 23", time: "08:00 - 09:00", title: "Registration & Networking Breakfast", speaker: "", type: "networking" },
  { id: "2", day: 1, dayLabel: "Day 1 - July 23", time: "09:00 - 09:30", title: "Opening Ceremony & Welcome Address", speaker: "Michael Otieno", type: "keynote" },
  { id: "3", day: 1, dayLabel: "Day 1 - July 23", time: "09:30 - 10:30", title: "Keynote: The Future of African Trade", speaker: "Hon. Grace Muthoni", type: "keynote" },
  { id: "4", day: 1, dayLabel: "Day 1 - July 23", time: "10:30 - 11:00", title: "Coffee Break & Exhibition Tour", speaker: "", type: "break" },
  { id: "5", day: 1, dayLabel: "Day 1 - July 23", time: "11:00 - 12:30", title: "Panel: Digital Transformation in Business", speaker: "Dr. Amina Wanjiku, James Omondi", type: "panel" },
  { id: "6", day: 1, dayLabel: "Day 1 - July 23", time: "12:30 - 14:00", title: "Networking Lunch", speaker: "", type: "networking" },
  { id: "7", day: 1, dayLabel: "Day 1 - July 23", time: "14:00 - 15:30", title: "Workshop: Export Readiness", speaker: "Sarah Njeri", type: "workshop" },
  { id: "8", day: 1, dayLabel: "Day 1 - July 23", time: "15:30 - 17:00", title: "Panel: Access to Finance for SMEs", speaker: "James Omondi, Prof. David Kamau", type: "panel" },
  { id: "9", day: 2, dayLabel: "Day 2 - July 24", time: "08:30 - 09:00", title: "Morning Networking Coffee", speaker: "", type: "networking" },
  { id: "10", day: 2, dayLabel: "Day 2 - July 24", time: "09:00 - 10:00", title: "Keynote: Building Sustainable Enterprises", speaker: "Prof. David Kamau", type: "keynote" },
  { id: "11", day: 2, dayLabel: "Day 2 - July 24", time: "10:00 - 11:30", title: "Panel: Women in Business Leadership", speaker: "Dr. Amina Wanjiku, Sarah Njeri", type: "panel" },
  { id: "12", day: 2, dayLabel: "Day 2 - July 24", time: "11:30 - 12:00", title: "Coffee Break", speaker: "", type: "break" },
  { id: "13", day: 2, dayLabel: "Day 2 - July 24", time: "12:00 - 13:00", title: "Workshop: Investment Pitch Masterclass", speaker: "James Omondi", type: "workshop" },
  { id: "14", day: 2, dayLabel: "Day 2 - July 24", time: "13:00 - 14:30", title: "Networking Lunch & Exhibition", speaker: "", type: "networking" },
  { id: "15", day: 2, dayLabel: "Day 2 - July 24", time: "14:30 - 16:00", title: "Panel: Infrastructure Development", speaker: "Hon. Grace Muthoni, Michael Otieno", type: "panel" },
  { id: "16", day: 2, dayLabel: "Day 2 - July 24", time: "16:00 - 17:30", title: "Workshop: E-commerce Strategies", speaker: "Dr. Amina Wanjiku", type: "workshop" },
  { id: "17", day: 3, dayLabel: "Day 3 - July 25", time: "08:30 - 09:00", title: "Morning Coffee", speaker: "", type: "networking" },
  { id: "18", day: 3, dayLabel: "Day 3 - July 25", time: "09:00 - 10:00", title: "Keynote: Regional Trade Integration", speaker: "Sarah Njeri", type: "keynote" },
  { id: "19", day: 3, dayLabel: "Day 3 - July 25", time: "10:00 - 11:30", title: "Panel: Youth Entrepreneurship", speaker: "Dr. Amina Wanjiku, Prof. David Kamau", type: "panel" },
  { id: "20", day: 3, dayLabel: "Day 3 - July 25", time: "11:30 - 12:00", title: "Coffee Break", speaker: "", type: "break" },
  { id: "21", day: 3, dayLabel: "Day 3 - July 25", time: "12:00 - 13:30", title: "Workshop: Business Continuity Planning", speaker: "James Omondi", type: "workshop" },
  { id: "22", day: 3, dayLabel: "Day 3 - July 25", time: "13:30 - 15:00", title: "Closing Lunch & Awards Ceremony", speaker: "Michael Otieno", type: "keynote" },
];
...
export const staticTestimonials: Testimonial[] = [
  {
    id: "1",
    quote: "Being a member of KNCCI Uasin Gishu has opened doors we never thought possible. Their advocacy for local businesses has significantly improved the operating environment in Eldoret.",
    name: "Dr. Isaac Kiprotich",
    title: "Managing Director",
    organization: "Eldo-Green Solutions",
  },
  {
    id: "2",
    quote: "The Certificate of Origin services provided by the chamber has smoothed our export processes to the EAC region. Their efficiency and support are unmatched.",
    name: "Mary Naliaka",
    title: "Exporter & CEO",
    organization: "Highland Fresh Traders",
  },
  {
    id: "3",
    quote: "Through the chamber's networking forums, I connected with strategic partners that helped scale my startup from a local shop to a regional distributor.",
    name: "Samuel Maina",
    title: "Founder",
    organization: "Maina Distributors Ltd",
  },
  {
    id: "4",
    quote: "The training sessions on digital transformation and market access have been invaluable. KNCCI isn't just an organization; it's a growth partner for SMEs.",
    name: "Grace Chebet",
    title: "General Manager",
    organization: "Innovate Eldoret Hub",
  },
];
...
export const staticGalaDinner: GalaDinner = {
  ...
  subtitle: "An exclusive evening to celebrate and connect at the Eldoret International Business Summit 2026",
  description: "Join fellow delegates, speakers, and partners for an elegant gala dinner that caps off the summit experience. The Gala Networking Dinner is a high-level occasion for stakeholders to forge lasting connections, celebrate achievements, and enjoy world-class hospitality at the Rupaz Mall Grounds.",
  ...
  priceMember: 1500,
  pricingTiers: [
    { label: "Individual Ticket", price: 3000 },
    { label: "Corporate Table", price: 30000 },
  ],
  currency: "KES",
  highlights: [
    "Networking with 5000+ business leaders",
