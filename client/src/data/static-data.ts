...
export const staticTestimonials: Testimonial[] = [
  {
    id: "1",
    quote: "KNCCI Uasin Gishu Chapter has been instrumental in connecting my business to the right partners. The chamber's support in policy advocacy has made a real difference for entrepreneurs like me.",
    name: "Seth Willy Ogutu",
    title: "Entrepreneur",
    organization: "KNCCI Member",
  },
  {
    id: "2",
    quote: "Joining the chamber was one of the best decisions I made for my business. The networking opportunities and access to market intelligence have helped me grow beyond what I thought possible.",
    name: "Noeline Maru",
  ...
  {
    id: "3",
    quote: "Through KNCCI, I have been able to access capacity building programmes and connect with fellow women in business. The chamber is truly a champion for inclusive economic growth in Uasin Gishu.",
    name: "Christine Chebet",
    title: "Entrepreneur",
    organization: "KNCCI Member",
  },
  {
    id: "4",
    quote: "The chamber's role in bringing together businesses, government, and investors has created a thriving ecosystem in Eldoret. I am proud to be part of this growing community.",
