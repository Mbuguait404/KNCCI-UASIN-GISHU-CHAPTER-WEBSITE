...
export function RegistrationSection() {
  const SUMMIT_URL = "https://summit.uasingishuchamber.co.ke/";

  const handleRedirect = () => {
    window.open(SUMMIT_URL, "_blank", "noopener,noreferrer");
  };
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-white/80 leading-relaxed">
            Join the Eldoret International Business Summit 2026.
            Eldoret City: Gateway to Africa's Trade, Innovation and Economic Future.
          </p>
        </motion.div>
            ...
            <motion.div variants={itemVariants}>
              <Card className="p-6 bg-white/5 border-white/10">
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div>
                    <div className="text-3xl font-bold text-secondary" data-testid="stat-speakers">200+</div>
                    <div className="text-sm text-white/60">Speakers</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-chart-3" data-testid="stat-sessions">60+</div>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Register today for the full summit experience including the Gala Networking Dinner.
                  </p>
                </div>
                ...
                <div className="space-y-3 text-left bg-muted/50 rounded-lg p-4">
                  ...
                  <div className="flex items-center gap-3">
                    <Sparkles className="w-4 h-4 text-primary" />
                    <span className="text-sm text-foreground">Rupaz Mall Grounds, Eldoret</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <Sparkles className="w-4 h-4 text-primary" />
                    <span className="text-sm text-foreground">Secure External Portal</span>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    <span>Register on Summit Site</span>
                    <motion.div
                      className="ml-2"
                      animate={{ x: [0, 4, 0] }}
                ...
                <p className="text-xs text-muted-foreground text-center">
                  You will be redirected to the official summit registration portal.
                </p>
              </div>
            </Card>
          </motion.div>
