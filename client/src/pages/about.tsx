            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl mx-auto">
                  The Voice of Business and the Champion for Economic
                  Transformation in Uasin Gishu County.
                </p>
              </motion.div>
            </div>
          </div>
              ...
              >
                ...
                <div className="space-y-8">
                  <div className="flex gap-6 p-6 rounded-2xl bg-primary/5 border border-primary/10">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-2 text-primary uppercase tracking-wide">
                        Vision
                      </h3>
                  ...
                  <div className="flex gap-6 p-6 rounded-2xl bg-secondary/5 border border-secondary/10">
                    ...
                    <div>
                      <h3 className="text-xl font-bold mb-2 text-secondary uppercase tracking-wide">
                        Mission
                      </h3>
                      <p className="text-muted-foreground text-lg italic leading-relaxed">
                        "To facilitate and promote a sustainable business
              ...
              >
                ...
                <div className="prose prose-lg dark:prose-invert">
                  <p className="text-xl text-muted-foreground leading-relaxed mb-6">
                    KNCCI Uasin Gishu chapter has a diverse membership base of{" "}
                    <span className="text-foreground font-bold font-serif italic underline decoration-primary/50 text-3xl mx-1">
                      6,500
                    </span>{" "}
                    that includes large corporations, SMEs, and individual
                    entrepreneurs.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    Membership is open to all businesses operating in Uasin
                    Gishu, and it offers various categories of membership to
                    suit different types of businesses and industries. Whether
                    you are a solo entrepreneur starting out or a large-scale
                    manufacturing plant, there is a place for you in our vibrant
                    community.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6 mt-10">
                  <div className="p-4 rounded-xl bg-background shadow-sm border border-border">
                    <div className="text-3xl font-bold text-primary mb-1 italic">
                      47
                    </div>
                  ...
                  <div className="p-4 rounded-xl bg-background shadow-sm border border-border">
                    <div className="text-3xl font-bold text-secondary mb-1 italic">
                      CIPE
                    </div>
                    <div className="text-sm text-muted-foreground uppercase tracking-wider font-semibold">
                      Supported Center
              ...
              >
                <div className="space-y-4 pt-12">
                  <div className="rounded-2xl overflow-hidden shadow-lg transform translate-y-4">
                    <img
                      src="https://solby.sfo3.digitaloceanspaces.com/1769687104798-WhatsApp%20Image%202026-01-27%20at%2009.11.09%20(2).jpeg"
                ...
                <div className="space-y-4">
                  <div className="rounded-2xl overflow-hidden shadow-lg bg-primary/10 aspect-square flex items-center justify-center p-8">
                    <div className="text-center">
                      ...
                      <span className="block text-2xl font-bold italic">
                  ...
                  <div className="rounded-2xl overflow-hidden shadow-lg transform -translate-y-8">
                    <img
                      src="https://solby.sfo3.digitaloceanspaces.com/1769687104848-WhatsApp%20Image%202026-01-27%20at%2009.11.09%20(4).jpeg"
                      alt="Team Workshop"
                      className="w-full h-auto"
                    />
                  </div>
            ...
            <div className="max-w-6xl mx-auto rounded-[3rem] overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 shadow-2xl border border-border flex flex-col lg:flex-row">
              <div className="p-12 lg:w-3/5">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed mb-8">
                  KNCCI-Uasin Gishu supports exporters to obtain the{" "}
                  <span className="text-foreground font-semibold underline decoration-primary/30">
                    Ordinary Certificate of Origin (COO)
                  </span>
                  .
                </p>
                <div className="space-y-4 mb-10">
                  <div className="flex gap-3 items-start">
                    ...
                    <p className="text-muted-foreground">
                      Certifies that goods are wholly obtained, produced,
                      manufactured, or processed in Kenya.
                    </p>
                  </div>
                  <div className="flex gap-3 items-start">
                    <div className="mt-1.5 w-2 h-2 rounded-full bg-primary flex-shrink-0" />
                    <p className="text-muted-foreground">
                      Issuance by Chambers of Commerce is an accepted practice
                      worldwide.
                    </p>
                  </div>
                  <div className="flex gap-3 items-start">
                    <div className="mt-1.5 w-2 h-2 rounded-full bg-primary flex-shrink-0" />
                    <p className="text-muted-foreground">
                      Essential document for cross-border trade and tariff
                      benefits.
                    </p>
                  </div>
                </div>
                ...
                >
                  <a
                    href="https://cmis.kenyachamber.or.ke/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Apply for COO Today <ArrowRight className="ml-2 w-4 h-4" />
                  </a>
                </Button>
              </div>
        ...
        <section className="py-24 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-16">
              ...
              <p className="text-muted-foreground leading-relaxed">
                As the leading business organization, we perform several
                critical functions to ensure the prosperity and protection of
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-5xl font-extrabold mb-8 tracking-tight">
                Become a part of the vibrant business community today
              </h2>
              <p className="text-xl md:text-2xl text-white/90 mb-12 italic opacity-80 leading-relaxed font-light">
                Join 6,500+ businesses and start benefiting from advocacy,
                networking, and expert trade facilitation services.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Button
                  size="lg"
                  variant="default"
                  className="rounded-full px-12 h-16 text-lg font-bold shadow-2xl hover:scale-105 transition-transform"
                  asChild
                >
                  <Link href="/membership">
                    Be a Member Now <Users2 className="ml-2 w-5 h-5" />
                  </Link>
                </Button>
                <Button
                  size="lg"
                  variant="destructive"
                  className="rounded-full px-12 h-16 text-lg font-bold border-2 border-white bg-transparent text-white hover:bg-white hover:text-primary transition-all duration-300"
                  asChild
                >
                  <Link href="/contact">
                    Learn More <Briefcase className="ml-2 w-5 h-5" />
                  </Link>
                </Button>
              </div>
            </motion.div>
