...
export default function Partnership() {
  ...
  const selectPackage = (tier: string) => {
    ...
    sponsorForm.setValue("tier", (newSelection ? (newSelection as InsertSponsorRequest["tier"]) : undefined) as any);
    if (newSelection) {
          ...
          <section className="py-20 bg-slate-50 dark:bg-slate-900/40 border-b border-border">
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                >
                  <span className="text-primary font-bold text-sm uppercase tracking-widest block mb-4">Partnership Opportunities</span>
